 ...
 * helper methods.
 */
public class MyIntentService extends IntentService implements SensorEventListener, StepListener {
...
//sensorrrrrr de  contar pasossssssssssssss
        ...
        numSteps=0;
        sensorManager.registerListener(MyIntentService.this, accel, SensorManager.SENSOR_DELAY_FASTEST);
